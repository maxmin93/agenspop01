...
public final class AgensJacksonModule extends SimpleModule {
    ...
    public static void writeWithType(final String key, final Object object
    ...
    public static List<String> writeProperties(final BaseElement element, final JsonGenerator jsonGenerator
    ...
    public static void writeScratch(final BaseElement element, final JsonGenerator jsonGenerator
